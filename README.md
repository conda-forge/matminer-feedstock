...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/matminer-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8136&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/matminer-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `matminer` can be installed with:

```
conda install matminer
```

It is possible to list all of the versions of `matminer` available on your platform with:
